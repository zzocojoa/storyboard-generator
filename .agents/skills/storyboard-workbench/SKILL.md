...
Current verification evidence is in the project Report: Schema 1.8.0, 48 unit/integration files, 1,054 tests, 256 required names, 15 Chromium cases, repeated Audio/Heartbeat/Bundle tests, and isolated Runtime Smoke. CI must succeed at the PR's current HEAD. This Skill is part of the generation fingerprint, so its edits require fresh generation requests.
