...
export function testGeneratorBuild(): GeneratorBuildProvenance {
  return { provenanceVersion: 1, headCommitSha: null, worktreeDirty: null, generationInputsDirty: null, generationContractSha256: null, runtimeGenerationConfigSha256: null, commitSha: null, appVersion: 'test-fixture', projectSchemaVersion: '1.8.0', builtAt: null, sourceTreeSha256: null };
}
