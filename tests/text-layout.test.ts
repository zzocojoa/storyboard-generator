...
describe('실제 글꼴의 공통 글자 배치', (): void => {
  ...
  it('text_layout_migration_keeps_legacy_hashes_and_all_original_fields', async (): Promise<void> => {
    ...
    expect(evidence.project).toEqual({ ...legacy, schemaVersion: '1.22.0', textLayout: storyboardTextPreset(), textReadability: fixture.project.textReadability, textLayoutControl: { version: '1.0.0', mode: 'manual', plannedInputHash: null } });
