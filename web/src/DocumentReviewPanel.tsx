...
export const REVIEW_ORIGIN_LABELS: Readonly<Record<ReviewAuditEntry['origin'], string>> = { document: '문서 확인', inference: 'Codex 추론', recommendation: 'Codex 추천', preset: '제작 프리셋', user: '사용자 지정' };
...
export function DocumentReviewPanel(props: { controls: ReviewControls; entries: readonly ReviewAuditEntry[]; preset: ProductionPreset | null;
  ...
  return <section className="document-section document-review-panel" aria-labelledby="document-codex-review-title">
    ...
    <div className="document-review-actions"><button type="button" className="document-primary" disabled={controls.working || controls.configured !== true}
    ...
    {suggestions.length > 0 && <div className="document-review-results">
      ...
      <details open={pending > 0}><summary>항목별 검토 근거 {suggestions.length}개</summary>
