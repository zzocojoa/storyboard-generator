import { z } from 'zod';
import { APPLY_INTENT_VERSION, REQUEST_JOURNAL_VERSION, REQUEST_LOCK_VERSION, REQUEST_SCHEMA_VERSION } from './codex/storage-contract.js';
...
export const BuildManifestSchema = GeneratorBuildProvenanceSchema.extend({
  ...
  requestSchemaVersion: z.literal(REQUEST_SCHEMA_VERSION), applyIntentVersion: z.literal(APPLY_INTENT_VERSION),
