...
2. **연결·설정**에서 장면·구간·원문 수와 연결할 항목을 확인한다. 문서로 연결된 항목은 접혀 있으며 펼쳐 수정할 수 있다. 이름↔ID 대응이 없는 인물은 **후보의 문서 근거 확인**에서 등장 장면·출처를 참고해 직접 연결한다. 장면 연결을 바꾸면 **연결 다시 확인**으로 원문 구간 후보를 갱신한다.
